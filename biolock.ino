...
void loop()                    
{
   ...
   //Serial.println("Beginning state machine");
   ...
   { 
      Serial.println("state:PASSWORD_OK");
...
void setServoPosition(int state) {
   if (state == LOCKED)
   {
